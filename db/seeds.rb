...
runs = [
  {
    start_time: DateTime.new(2023, 4, 24, 17, 0, 0, '+9'),
    end_time: DateTime.new(2023, 4, 24, 19, 0, 0, '+9'),
    status: "suggested",
  ...
  {
    start_time: DateTime.new(2023, 4, 23, 18, 0, 0, '+9'),
    end_time: DateTime.new(2023, 4, 23, 20, 0, 0, '+9'),
    status: "suggested",
    weather_description: "Clear sky",
    wind: 8.0,
    humidity: 63.0,
  ...
  {
    start_time: DateTime.new(2023, 4, 25, 17, 0, 0, '+9'),
    end_time: DateTime.new(2023, 4, 25, 19, 0, 0, '+9'),
    status: "suggested",
    weather_description: "Clear sky",
    wind: 7.0,
    humidity: 65,
  ...
  {
    start_time: DateTime.new(2023, 4, 21, 17, 0, 0, '+9'),
    end_time: DateTime.new(2023, 4, 21, 19, 0, 0, '+9'),
    status: "scheduled",
    weather_description: "Clear sky",
    wind: 8.0, humidity: 63.0,
    precipitation: 0.0,
  ...
  {
    start_time: DateTime.new(2023, 4, 22, 17, 0, 0, '+9'),
    end_time: DateTime.new(2023, 4, 22, 19, 0, 0, '+9'),
    status: "scheduled",
    weather_description: "Clear sky",
    wind: 8.0, humidity: 63.0,
    precipitation: 0.0,
  ...
  {
    start_time: DateTime.new(2023, 4, 18, 19, 0, 0, '+9'),
    end_time: DateTime.new(2023, 4, 18, 22, 0, 0, '+9'),
    status: "completed",
    weather_description: "Clear sky",
    wind: 8.0, humidity: 63.0,
    precipitation: 0.0,
  ...
  {
    start_time: DateTime.new(2023, 4, 17, 17, 0, 0, '+9'),
    end_time: DateTime.new(2023, 4, 17, 19, 0, 0, '+9'),
    status: "completed",
  ...
  {
    start_time: DateTime.new(2023, 4, 16, 19, 0, 0, '+9'),
    end_time: DateTime.new(2023, 4, 16, 21, 0, 0, '+9'),
    status: "completed",
    weather_description: "Few clouds: 11-25%",
    wind: 7.0,
    humidity: 64.0,
  ...
  {
    start_time: DateTime.new(2023, 4, 15, 17, 0, 0, '+9'),
    end_time: DateTime.new(2023, 4, 15, 19, 0, 0, '+9'),
    status: "completed",
  ...
  {
    start_time: DateTime.new(2023, 4, 14, 17, 0, 0, '+9'),
    end_time: DateTime.new(2023, 4, 14, 19, 0, 0, '+9'),
    status: "completed",
    weather_description: "Few clouds: 11-25%",
    wind: 8.0,
    humidity: 66.0,
