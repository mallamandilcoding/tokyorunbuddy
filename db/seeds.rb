...
puts "Creating runs..."
runs = [
  { date: Date.new(2023, 3, 3), start_time: Time.new(2023, 3, 3, 20), end_time: Time.new(2023, 3, 3, 22), status: "scheduled", weather: 15, wind: 25.0, humidity: 10, precipitation: 0.0, air_quality: 1, user: User.first, location: Location.first },
  { date: Date.new(2023, 3, 4), start_time: Time.new(2023, 3, 4, 16), end_time: Time.new(2023, 3, 3, 18), status: "scheduled", weather: 18, wind: 20.0, humidity: 10, precipitation: 0.0, air_quality: 1, user: User.first, location: Location.first },
  { date: Date.new(2023, 3, 5), start_time: Time.new(2023, 3, 5, 16), end_time: Time.new(2023, 3, 5, 18), status: "suggested", weather: 17, wind: 18.0, humidity: 8, precipitation: 0.0, air_quality: 1, user: User.first, location: Location.first },
  { date: Date.new(2023, 3, 5), start_time: Time.new(2023, 3, 5, 12), end_time: Time.new(2023, 3, 5, 14), status: "suggested", weather: 16, wind: 10.0, humidity: 5, precipitation: 0.0, air_quality: 1, user: User.first, location: Location.first },
  { date: Date.new(2023, 3, 6), start_time: Time.new(2023, 3, 6, 19), end_time: Time.new(2023, 3, 6, 21), status: "suggested", weather: 15, wind: 25.0, humidity: 10, precipitation: 0.0, air_quality: 1, user: User.first, location: Location.first },
  { date: Date.new(2023, 2, 26), start_time: Time.new(2023, 2, 26, 16), end_time: Time.new(2023, 2, 26, 18), status: "completed", weather: 15, wind: 25.0, humidity: 10, precipitation: 0.0, air_quality: 1, user: User.first, location: Location.first }
]
